...
const CsvDataGeneratorWizard: FunctionComponent = () => {
  ...
  return (
    <>
      <Typography variant="body2">{t("SELECT_CSV_DATA_DESCRIPTION")}</Typography>

      <GenerateAndDownloadButton disabled={isScanning} onClick={startGeneration} calendarType="csv-data" />
    </>
  );
};
