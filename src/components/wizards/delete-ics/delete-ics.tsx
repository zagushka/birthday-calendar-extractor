...
const DeleteIcsGeneratorWizard: FunctionComponent = () => {
  ...
  return (
    <>
      <Typography variant="body2">{t("SELECT_DELETE_ICS_DESCRIPTION")}</Typography>

      <GenerateAndDownloadButton disabled={isScanning} onClick={startGeneration} calendarType="delete-ics" />
    </>
  );
};
